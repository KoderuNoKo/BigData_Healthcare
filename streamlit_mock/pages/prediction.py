...
st.title("MIMIC-IV Predictive Analytics Dashboard")
st.markdown("""
**AI-Driven Risk Assessment & Resource Forecasting** *Leveraging Big Data technologies to provide early warnings for ICU patient outcomes.*
""")
